...
public final class MemoryFill__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6843dd2L, "WebAssembly.structure.MemoryFill");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] instrCode = Bytes.u32BytesLeb128(11);

    return 2 + instrCode.length;
  }
  ...
  /*package*/ MemoryFill__BehaviorDescriptor() {
  }
