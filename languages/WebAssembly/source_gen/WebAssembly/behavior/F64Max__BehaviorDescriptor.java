...
public final class F64Max__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a6538eL, "WebAssembly.structure.F64Max");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xA5;
    return new byte[]{instr};
  }

  /*package*/ F64Max__BehaviorDescriptor() {
  }
