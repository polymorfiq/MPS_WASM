...
public final class PassiveElem__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.y$3pti)).visitAll((idx) -> funcSize.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(idx));
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    switch (enumSwitchIndex.indexNullable(SPropertyOperations.getEnum(__thisNode__, PROPS.et$3j7R))) {
      case 0:
        bytes[i.value] = 0x00;
        break;
    }
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.y$3pti)).visitAll((idx) -> {
