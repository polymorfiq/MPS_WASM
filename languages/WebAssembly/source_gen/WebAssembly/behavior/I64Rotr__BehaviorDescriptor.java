...
public final class I64Rotr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a5aa3fL, "WebAssembly.structure.I64Rotr");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0x8A;
    return new byte[]{instr};
  }

  /*package*/ I64Rotr__BehaviorDescriptor() {
  }
