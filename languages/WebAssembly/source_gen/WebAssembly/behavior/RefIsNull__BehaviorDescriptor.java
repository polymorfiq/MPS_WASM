...
public final class RefIsNull__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f57de574L, "WebAssembly.structure.RefIsNull");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return new byte[]{(byte) 0xD1};
  }

  /*package*/ RefIsNull__BehaviorDescriptor() {
  }
