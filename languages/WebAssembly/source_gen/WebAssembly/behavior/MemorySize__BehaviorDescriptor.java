...
public final class MemorySize__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f681236cL, "WebAssembly.structure.MemorySize");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return new byte[]{(byte) 0x3F, (byte) 0x00};
  }

  /*package*/ MemorySize__BehaviorDescriptor() {
  }
