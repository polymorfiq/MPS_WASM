...
public final class MemoryCopy__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6837160L, "WebAssembly.structure.MemoryCopy");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] instrCode = Bytes.u32BytesLeb128(10);

    return 3 + instrCode.length;
  }
  ...
  /*package*/ MemoryCopy__BehaviorDescriptor() {
  }
