...
public final class I32TruncSatF32S__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6b4c6cbL, "WebAssembly.structure.I32TruncSatF32S");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] opcode = Bytes.u32BytesLeb128(0);
    System.arraycopy(opcode, 0, bytes, 1, opcode.length);

    return bytes;
  }

  /*package*/ I32TruncSatF32S__BehaviorDescriptor() {
  }
