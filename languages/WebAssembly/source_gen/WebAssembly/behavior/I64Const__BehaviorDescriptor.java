...
public final class I64Const__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f524766fL, "WebAssembly.structure.I64Const");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] numBytes = Bytes.i64BytesLeb128(SPropertyOperations.getString(__thisNode__, PROPS.value$eedi));
  ...
  /*package*/ I64Const__BehaviorDescriptor() {
  }
