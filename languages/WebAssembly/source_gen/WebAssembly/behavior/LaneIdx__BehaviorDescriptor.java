...
public final class LaneIdx__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6d62480L, "WebAssembly.structure.LaneIdx");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return new byte[]{Bytes.u8Byte(SPropertyOperations.getInteger(__thisNode__, PROPS.value$_awj))};
  }

  /*package*/ LaneIdx__BehaviorDescriptor() {
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty value$_awj = MetaAdapterFactory.getProperty(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6d62480L, 0x39e7fc40f6d62482L, "value");
  }
}
