...
public final class CodeSection__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f5469decL, "WebAssembly.structure.CodeSection");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.codes$r1Ct)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode code) {
        contentLen.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(code);
      }
    });
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.codes$r1Ct)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode code) {
        byte[] codeBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(code);
        System.arraycopy(codeBytes, 0, bytes, i.value, codeBytes.length);
        i.value += codeBytes.length;
      }
    });
  ...
  /*package*/ CodeSection__BehaviorDescriptor() {
  }
