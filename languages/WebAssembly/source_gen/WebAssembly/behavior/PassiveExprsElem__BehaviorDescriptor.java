...
public final class PassiveExprsElem__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f7e6014aL, "WebAssembly.structure.PassiveExprsElem");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] opcode = Bytes.u32BytesLeb128(5);
    byte[] vecLen = Bytes.u32BytesLeb128(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.el$i34u)).count());

    final Wrappers._int exprsSize = new Wrappers._int(0);
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.el$i34u)).visitAll((expr) -> exprsSize.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(expr));
    return opcode.length + (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.et$i8GQ)) + vecLen.length + exprsSize.value;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] refTypeBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.et$i8GQ));
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.el$i34u)).visitAll((expr) -> {
  ...
  /*package*/ PassiveExprsElem__BehaviorDescriptor() {
  }
