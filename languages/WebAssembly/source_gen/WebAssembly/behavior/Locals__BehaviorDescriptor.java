...
public final class Locals__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f53e0dd6L, "WebAssembly.structure.Locals");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] idxBytes = Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.n$WmRt));
    return idxBytes.length + (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.t$WsgO));
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] typeBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.t$WsgO));
    System.arraycopy(typeBytes, 0, bytes, i, typeBytes.length);

    return bytes;
  }

  /*package*/ Locals__BehaviorDescriptor() {
  }
