...
public final class TypeIdxBlockType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f584baf2L, "WebAssembly.structure.TypeIdxBlockType");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    return Bytes.i33BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.x$D0Wt)).length;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return Bytes.i33BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.x$D0Wt));
  }

  /*package*/ TypeIdxBlockType__BehaviorDescriptor() {
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty x$D0Wt = MetaAdapterFactory.getProperty(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f584baf2L, 0x39e7fc40f584baf3L, "x");
  }
}
