...
public final class MemArg__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f66ec7baL, "WebAssembly.structure.MemArg");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] alignBytes = Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.align$$5l0));
    byte[] offsetBytes = Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.offset$$5N2));
    return alignBytes.length + offsetBytes.length;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    int i = 0;
    byte[] alignBytes = Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.align$$5l0));
    System.arraycopy(alignBytes, 0, bytes, i, alignBytes.length);
    i += alignBytes.length;

    byte[] offsetBytes = Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.offset$$5N2));
    System.arraycopy(offsetBytes, 0, bytes, i, offsetBytes.length);

    return bytes;
  }

  /*package*/ MemArg__BehaviorDescriptor() {
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty align$$5l0 = MetaAdapterFactory.getProperty(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f66ec7baL, 0x39e7fc40f66ec7beL, "align");
    /*package*/ static final SProperty offset$$5N2 = MetaAdapterFactory.getProperty(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f66ec7baL, 0x39e7fc40f66ec7c0L, "offset");
  }
}
