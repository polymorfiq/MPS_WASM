...
public final class F64Add__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a62fa3L, "WebAssembly.structure.F64Add");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xA0;
    return new byte[]{instr};
  }

  /*package*/ F64Add__BehaviorDescriptor() {
  }
