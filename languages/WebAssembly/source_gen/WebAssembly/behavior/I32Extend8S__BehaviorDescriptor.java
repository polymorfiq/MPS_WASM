...
public final class I32Extend8S__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a704a3L, "WebAssembly.structure.I32Extend8S");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xC0;
    return new byte[]{instr};
  }

  /*package*/ I32Extend8S__BehaviorDescriptor() {
  }
