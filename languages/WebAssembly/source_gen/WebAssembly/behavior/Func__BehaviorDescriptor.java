...
public final class Func__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f543f0f3L, "WebAssembly.structure.Func");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    final Wrappers._int localsLen = new Wrappers._int(0);
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.locals$w0AZ)).visitAll((local) -> localsLen.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(local));
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.locals$w0AZ)).visitAll((local) -> {
      byte[] localBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(local);
      System.arraycopy(localBytes, 0, bytes, i.value, localBytes.length);
      i.value += localBytes.length;
    });
  ...
  /*package*/ Func__BehaviorDescriptor() {
  }
