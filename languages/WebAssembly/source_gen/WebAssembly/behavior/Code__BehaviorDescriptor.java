...
public final class Code__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f545b99aL, "WebAssembly.structure.Code");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] codeLen = Bytes.u32BytesLeb128((int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.func$aeX1)));
    return codeLen.length + (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.func$aeX1));
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    int i = 0;
    byte[] codeLen = Bytes.u32BytesLeb128((int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.func$aeX1)));
    System.arraycopy(codeLen, 0, bytes, i, codeLen.length);
    i += codeLen.length;

    byte[] codeBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.func$aeX1));
    System.arraycopy(codeBytes, 0, bytes, i, codeBytes.length);

    return bytes;
  }

  /*package*/ Code__BehaviorDescriptor() {
  }
