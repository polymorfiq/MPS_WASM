...
public final class I32TruncF32S__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a668f4L, "WebAssembly.structure.I32TruncF32S");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xA8;
    return new byte[]{instr};
  }

  /*package*/ I32TruncF32S__BehaviorDescriptor() {
  }
