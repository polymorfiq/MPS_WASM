...
public final class I32TruncF64U__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a6780dL, "WebAssembly.structure.I32TruncF64U");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xAB;
    return new byte[]{instr};
  }

  /*package*/ I32TruncF64U__BehaviorDescriptor() {
  }
