...
public final class TableSection__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x6f2b0ba03281be3bL, "WebAssembly.structure.TableSection");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.tables$paDe)).visitAll((idx) -> contentLen.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(idx));

    byte[] vecLength = Bytes.u32BytesLeb128(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.tables$paDe)).count());
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    final Wrappers._int contentLen = new Wrappers._int(0);
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.tables$paDe)).visitAll((table) -> contentLen.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(table));
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.tables$paDe)).visitAll((table) -> {
      byte[] tableBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(table);
      System.arraycopy(tableBytes, 0, bytes, i.value, tableBytes.length);
      i.value += tableBytes.length;
    });

    return bytes;
  }

  /*package*/ TableSection__BehaviorDescriptor() {
  }
