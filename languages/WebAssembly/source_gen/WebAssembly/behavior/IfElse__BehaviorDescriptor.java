...
public final class IfElse__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.if_instrs$6anj)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode instr) {
        instrSize.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(instr);
      }
    });
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.else_instrs$tFcj)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode instr) {
        instrSize.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(instr);
      }
    });
