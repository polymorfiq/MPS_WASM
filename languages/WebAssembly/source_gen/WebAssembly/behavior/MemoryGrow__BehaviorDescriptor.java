...
public final class MemoryGrow__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6815d80L, "WebAssembly.structure.MemoryGrow");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return new byte[]{(byte) 0x40, (byte) 0x00};
  }

  /*package*/ MemoryGrow__BehaviorDescriptor() {
  }
