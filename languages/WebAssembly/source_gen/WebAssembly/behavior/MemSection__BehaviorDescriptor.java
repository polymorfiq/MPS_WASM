...
public final class MemSection__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.mems$MXjv)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode mem) {
        contentLen.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(mem);
      }
    });
