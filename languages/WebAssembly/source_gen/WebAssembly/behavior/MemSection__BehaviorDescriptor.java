...
public final class MemSection__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x6f2b0ba0328d211dL, "WebAssembly.structure.MemSection");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.mems$MXjv)).visitAll((mem) -> contentLen.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(mem));

    byte[] vecLength = Bytes.u32BytesLeb128(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.mems$MXjv)).count());
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.mems$MXjv)).visitAll((table) -> {
      byte[] memBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(table);
      System.arraycopy(memBytes, 0, bytes, i.value, memBytes.length);
      i.value += memBytes.length;
    });

    return bytes;
  }

  /*package*/ MemSection__BehaviorDescriptor() {
  }
