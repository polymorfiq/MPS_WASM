...
public final class I32TruncF64S__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a67410L, "WebAssembly.structure.I32TruncF64S");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xAA;
    return new byte[]{instr};
  }

  /*package*/ I32TruncF64S__BehaviorDescriptor() {
  }
