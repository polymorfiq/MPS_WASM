...
public final class I32Const__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f506bb60L, "WebAssembly.structure.I32Const");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] numBytes = Bytes.i32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.value$l9MY));
    return numBytes.length + 1;
  }
  ...
  /*package*/ I32Const__BehaviorDescriptor() {
  }
