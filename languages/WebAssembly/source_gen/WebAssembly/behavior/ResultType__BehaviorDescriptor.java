...
public final class ResultType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x601bfff8ed7aee8aL, "WebAssembly.structure.ResultType");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.data$_MXP)).visitAll((data) -> content_size.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(data));
    byte[] count = Bytes.u32BytesLeb128(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.data$_MXP)).count());

    return content_size.value + count.length;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] count = Bytes.u32BytesLeb128(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.data$_MXP)).count());
    System.arraycopy(count, 0, data, 0, count.length);

    final Wrappers._int i = new Wrappers._int(count.length);
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.data$_MXP)).visitAll((item) -> {
  ...
  /*package*/ ResultType__BehaviorDescriptor() {
  }
