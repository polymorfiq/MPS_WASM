...
public final class ActiveExplicitExprsElem__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] opcode = Bytes.u32BytesLeb128(6);
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] idxBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.x$uCw0));
    System.arraycopy(idxBytes, 0, bytes, i.value, idxBytes.length);
    i.value += idxBytes.length;

    byte[] exprBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.e$uBMX));
    System.arraycopy(exprBytes, 0, bytes, i.value, exprBytes.length);
    i.value += exprBytes.length;

    byte[] refBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.et$uPCS));
    System.arraycopy(refBytes, 0, bytes, i.value, refBytes.length);
    i.value += refBytes.length;
  ...
  /*package*/ ActiveExplicitExprsElem__BehaviorDescriptor() {
  }
