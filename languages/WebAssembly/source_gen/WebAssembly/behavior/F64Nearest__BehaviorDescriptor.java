...
public final class F64Nearest__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a6244cL, "WebAssembly.structure.F64Nearest");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0x9E;
    return new byte[]{instr};
  }

  /*package*/ F64Nearest__BehaviorDescriptor() {
  }
