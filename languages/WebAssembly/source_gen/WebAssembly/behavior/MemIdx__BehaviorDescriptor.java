...
public final class MemIdx__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f52b27f1L, "WebAssembly.structure.MemIdx");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    return Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.value$R5Bt)).length;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.value$R5Bt));
  }

  /*package*/ MemIdx__BehaviorDescriptor() {
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty value$R5Bt = MetaAdapterFactory.getProperty(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f52b27f1L, 0x39e7fc40f52b27f2L, "value");
  }
}
