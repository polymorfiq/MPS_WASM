...
public final class F32Const__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f50cd7bcL, "WebAssembly.structure.F32Const");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] valBytes = Bytes.f32Bytes(SPropertyOperations.getString(__thisNode__, PROPS.value$FF8t));
    System.arraycopy(valBytes, 0, bytes, 1, valBytes.length);

    return bytes;
  }

  /*package*/ F32Const__BehaviorDescriptor() {
  }
