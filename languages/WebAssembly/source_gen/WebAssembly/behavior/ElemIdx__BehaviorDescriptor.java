...
public final class ElemIdx__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f66bd1daL, "WebAssembly.structure.ElemIdx");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    return Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.value$xxlY)).length;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    return Bytes.u32BytesLeb128(SPropertyOperations.getInteger(__thisNode__, PROPS.value$xxlY));
  }

  /*package*/ ElemIdx__BehaviorDescriptor() {
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty value$xxlY = MetaAdapterFactory.getProperty(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f66bd1daL, 0x39e7fc40f66bd1dcL, "value");
  }
}
