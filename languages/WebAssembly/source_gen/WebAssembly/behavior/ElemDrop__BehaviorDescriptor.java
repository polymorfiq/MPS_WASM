...
public final class ElemDrop__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f66deb69L, "WebAssembly.structure.ElemDrop");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] instrCode = Bytes.u32BytesLeb128(13);

    return 1 + instrCode.length + (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.x$1FYN));
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    byte[] sourceBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.x$1FYN));
    System.arraycopy(sourceBytes, 0, bytes, i, sourceBytes.length);

    return bytes;
  }

  /*package*/ ElemDrop__BehaviorDescriptor() {
  }
