...
public final class I64ShrU__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a59f23L, "WebAssembly.structure.I64ShrU");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0x88;
    return new byte[]{instr};
  }

  /*package*/ I64ShrU__BehaviorDescriptor() {
  }
