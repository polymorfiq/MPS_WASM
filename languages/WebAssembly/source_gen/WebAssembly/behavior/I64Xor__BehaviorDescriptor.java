...
public final class I64Xor__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a5900dL, "WebAssembly.structure.I64Xor");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0x85;
    return new byte[]{instr};
  }

  /*package*/ I64Xor__BehaviorDescriptor() {
  }
