...
public final class I64ExtendI32S__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a67f32L, "WebAssembly.structure.I64ExtendI32S");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xAC;
    return new byte[]{instr};
  }

  /*package*/ I64ExtendI32S__BehaviorDescriptor() {
  }
