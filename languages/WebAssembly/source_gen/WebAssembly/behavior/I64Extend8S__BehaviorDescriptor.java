...
public final class I64Extend8S__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a70fbfL, "WebAssembly.structure.I64Extend8S");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xC2;
    return new byte[]{instr};
  }

  /*package*/ I64Extend8S__BehaviorDescriptor() {
  }
