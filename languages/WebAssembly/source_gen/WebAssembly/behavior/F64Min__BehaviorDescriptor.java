...
public final class F64Min__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a64c6cL, "WebAssembly.structure.F64Min");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0xA4;
    return new byte[]{instr};
  }

  /*package*/ F64Min__BehaviorDescriptor() {
  }
