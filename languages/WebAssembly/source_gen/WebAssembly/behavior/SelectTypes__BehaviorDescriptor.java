...
public final class SelectTypes__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.t$ZMrY)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        vecSize.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(it);
      }
    });
