...
public final class SelectTypes__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6575ffeL, "WebAssembly.structure.SelectTypes");
  ...
  /*package*/ static int byte_size_id60rZZzHEXgh(@NotNull SNode __thisNode__) {
    byte[] vecLength = Bytes.u32BytesLeb128(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.t$ZMrY)).count());
    final Wrappers._int vecSize = new Wrappers._int(0);
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.t$ZMrY)).visitAll((it) -> vecSize.value += (int) ByteSized__BehaviorDescriptor.byte_size_id60rZZzHEXgh.invoke(it));

    return 1 + vecLength.length + vecSize.value;
  }
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.t$ZMrY)).visitAll((it) -> {
      byte[] itemBytes = ByteSized__BehaviorDescriptor.bytes_id60rZZzHEXiv.invoke(it);
      System.arraycopy(itemBytes, 0, bytes, i.value, itemBytes.length);
  ...
  /*package*/ SelectTypes__BehaviorDescriptor() {
  }
