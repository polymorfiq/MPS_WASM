...
public final class F32Add__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x39e7fc40f6a5d3c5L, "WebAssembly.structure.F32Add");
  ...
  /*package*/ static byte[] bytes_id60rZZzHEXiv(@NotNull SNode __thisNode__) {
    byte instr = (byte) 0x92;
    return new byte[]{instr};
  }

  /*package*/ F32Add__BehaviorDescriptor() {
  }
