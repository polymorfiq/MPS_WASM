...
/*package*/ class ImportTableDesc_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ImportTableDesc_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_blcuu1_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_blcuu1_a0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_blcuu1_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new tabletypeSingleRoleHandler_blcuu1_c0(myNode, LINKS.tabletype$5w4l, getEditorContext());
    return provider.createCell();
  }
  private static class tabletypeSingleRoleHandler_blcuu1_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public tabletypeSingleRoleHandler_blcuu1_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_blcuu1_d0");
    Style style = new StyleImpl();
