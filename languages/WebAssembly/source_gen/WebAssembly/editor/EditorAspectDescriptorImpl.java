...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 224:
        return Collections.<ConceptEditor>singletonList(new ImportGlobalTypeDesc_Editor());
      case 225:
        return Collections.<ConceptEditor>singletonList(new ImportMemTypeDesc_Editor());
      case 226:
        return Collections.<ConceptEditor>singletonList(new ImportSection_Editor());
      case 227:
        return Collections.<ConceptEditor>singletonList(new ImportTableTypeDesc_Editor());
      case 228:
        return Collections.<ConceptEditor>singletonList(new ImportTypeIdxDesc_Editor());
      case 229:
