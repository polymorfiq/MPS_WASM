...
/*package*/ class Module_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new sectionsListHandler_iuuvkg_a1b0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_sections");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class sectionsListHandler_iuuvkg_a1b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public sectionsListHandler_iuuvkg_a1b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.sections$6WTp;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ModuleSection$wp;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sectionsListHandler_iuuvkg_a1b0.this.getNode(), LINKS.sections$6WTp));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ModuleSection$wp = MetaAdapterFactory.getConcept(0xf0ceec7784bd4104L, 0xb53284a17dffbb8aL, 0x601bfff8ed886ae4L, "WebAssembly.structure.ModuleSection");
  }
